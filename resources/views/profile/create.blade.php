                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                                                            ...
                                                                            <div class="single-input mb-25">
                                                                                ...
                                                                                <input type="text" id="phone_number" name="phone_number" placeholder="電話番号" value="{{old('phone_number')}}">
                                                                        ...
                                                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                                            <!-- Single Input Start -->
                                                                            <div class="single-input mb-25">
                                                                                <label for="bio">経験・経歴（２０文字以上）<span>*</span></label>
                                                                                <textarea id="exrerience" name="experience" placeholder="経験・経歴">{{old('experience')}}</textarea>
                                                                        ...
                                                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                                            <!-- Single Input Start -->
                                                                            <div class="single-input mb-25">
                                                                                <label for="bio">自己紹介など</label>
                                                                                <textarea id="bio" name="bio" placeholder="自己紹介など">{{old('bio')}}</textarea>
                                                                                @if($errors->has('bio'))
