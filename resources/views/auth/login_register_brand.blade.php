                                ...
                                <div id="register" class="tab-pane fade">
                                    <div class="login-register-form">
                                        <form method="POST" action="{{ route('brd.register') }}">@csrf
                                            ...
                                            <div class="col-12">
                                                <div class="single-input">
                                                    <input id="name" type="text" placeholder="ブランドネーム" class="form-control @error('brand_name') is-invalid @enderror" name="brand_name" value="{{ old('brand_name') }}" required autocomplete="name" autofocus>
